            ...
            <div className="rounded-xl border border-white/10 bg-black/40 backdrop-blur shadow-lg overflow-hidden">
                <table className="w-full text-left">
                    <thead className="bg-white/5 border-b border-white/10">
                        <tr>
                            <th className="px-4 py-3 text-white/70 font-medium">#</th>
                            <th className="px-4 py-3 text-white/70 font-medium">Player</th>
                            <th className="px-4 py-3 text-right text-white/70 font-medium">Elo</th>
                        </tr>
                    </thead>
